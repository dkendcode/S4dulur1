...
<div class="row">
	...
	<div class="col-12">
		<div style="padding-bottom: 5px; padding-top: 5px;">
		  ...
		  <button class="btn bg-primary" onclick="exportTableToCSV('report-dkendcode-<?= $filedownload . $fprefix; ?>.csv')" title="Download selling report"><i class="fa fa-download"></i> CSV</button>
